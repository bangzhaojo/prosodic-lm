...
kmeans10 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_10clu_6features.pkl")
kmeans20 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_20clu_6features.pkl")
kmeans50 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_50clu_6features.pkl")
kmeans100 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_100clu_6features.pkl")
kmeans200 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_200clu_6features.pkl")
kmeans500 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_500clu_6features.pkl")
kmeans1000 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_1000clu_6features.pkl")
print('done.')
...
for idx, filename in enumerate(tqdm(files, desc="Processing files", unit="file")):
    ...
    try:
        ...
        # Apply clustering
        prosody_id_10 = kmeans10.predict(X)
        prosody_id_20 = kmeans20.predict(X)
