...
# def main(transcript_path, metadata_path, download_directory, output_directory, start_line, n_processes):
#     files = [f for f in os.listdir(transcript_path) if f.endswith('.csv')][start_line:]

#     with ProcessPoolExecutor(max_workers=n_processes) as executor:
#         # Submit each file for processing
#         futures = {
#             executor.submit(
#                 process_file, i + start_line, filename, transcript_path, metadata_path, download_directory, output_directory
