...
output_dir = "/shared/3/projects/bangzhao/prosodic_embeddings/merge/training_data_6features/"

# Load clustering models (each one includes both kmeans and its corresponding scaler)
kmeans10, scaler10 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_10clu_6features.pkl")
kmeans20, scaler20 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_20clu_6features.pkl")
kmeans50, scaler50 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_50clu_6features.pkl")
kmeans100, scaler100 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_100clu_6features.pkl")
kmeans200, scaler200 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_200clu_6features.pkl")
kmeans500, scaler500 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_500clu_6features.pkl")
kmeans1000, scaler1000 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_1000clu_6features.pkl")
print('done.')
