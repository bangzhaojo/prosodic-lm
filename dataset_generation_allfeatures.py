...
output_dir = "/shared/3/projects/bangzhao/prosodic_embeddings/merge/training_data_allfeatures/"

# Load clustering models (each one includes both kmeans and its corresponding scaler)
kmeans10, scaler10 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_10clu_allfeatures.pkl")
kmeans20, scaler20 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_20clu_allfeatures.pkl")
kmeans50, scaler50 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_50clu_allfeatures.pkl")
kmeans100, scaler100 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_100clu_allfeatures.pkl")
kmeans200, scaler200 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_200clu_allfeatures.pkl")
kmeans500, scaler500 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_500clu_allfeatures.pkl")
kmeans1000, scaler1000 = joblib.load("/shared/3/projects/bangzhao/prosodic_embeddings/merge/clustering/kmeans_10000epi_1000clu_allfeatures.pkl")
print('done.')
...
for idx, filename in enumerate(tqdm(files, desc="Processing files", unit="file")):
    ...
    try:
        ...
        data = data.dropna(subset=['F0semitoneFrom27.5Hz_sma3nz', 'F1frequency_sma3nz', 'mfcc1_sma3', 'mfcc2_sma3', 
