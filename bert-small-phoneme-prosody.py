...
class HuggingFacePhonemeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        prosody_ids = sample["prosody_id_20"][start:start + self.max_length]  # change cluster size here
...
hf_dataset = load_dataset("json", data_files="/shared/3/projects/bangzhao/prosodic_embeddings/merge/training_data_f0f1/output_part_1_20kSample.jsonl", split="train")
...
# Set paths
save_dir = "/shared/3/projects/bangzhao/prosodic_embeddings/bert_train/mlm_prosody_20kSample_f0f1_20clu/"
